...
import 'package:minesweeper/game/settings_view.dart';
            ...
            appBar: AppBar(
              ...
              title: BlocBuilder<GameCubit, GameState>(
                builder: (context, state) {
                  final numFlags =
                      state.squareStates.where((e) => e.flag).length;
              ...
              actions: [
                ...
                IconButton(
                  onPressed: () async {
                    ...
                    // Once done with the changes, save them to local storage
                    settingState.toLocalStorage();
                  },
                  icon: const Icon(
                    Icons.settings,
                    color: Colors.black54,
